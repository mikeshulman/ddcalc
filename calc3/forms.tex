...
Of particular interest is the differential form $f(x+\dx)-f(x)$, for some function $f$ of $x$.
The graph of this form at some value of $x$ looks just like a piece of the graph of $f$ near $x$, but shifted down so that it crosses the $x$-axis at the point $(x,0)$ (this is what subtracting $f(x)$ accomplishes).
Here we show the ordinary graph of some arbitrary function $f$, along with a graph of $f(x+\dx)-f(x)$ done as above.
\begin{center}
  \begin{tikzpicture}
    \draw[<->] (-5,0) -- (5,0);
    \draw[<->] (0,-2) -- (0,2);
    ...
    \draw (-3,.2) -- (-3,-.2);
    \draw (-4,-.2) -- (-4,.2);
    \draw[purple,very thick] (-5,.3) to[out=30,in=170] (-4,1) to[out=-10,in=110] (-2,-1.2) to[out=-70,in=-130] (1,.2) to[out=50,in=120] (5,-.5) node[below right] {$f(x)$};
    \def\drawit#1{\draw[blue,very thick,yshift=#1] (-5,.3) to[out=30,in=170] (-4,1) to[out=-10,in=110] (-2,-1.2) to[out=-70,in=-130] (1,.2) to[out=50,in=120] (5,-.5);}
    \begin{scope} \clip (-.3,-.3) rectangle (0.3,.3); \drawit{.85cm} \end{scope}
    \begin{scope} \clip (0.7,-.3) rectangle (1.3,.3); \drawit{-.2cm} \end{scope}
    \begin{scope} \clip (1.7,-.3) rectangle (2.3,.3); \drawit{-.81cm} \end{scope}
    \begin{scope} \clip (2.7,-.3) rectangle (3.3,.3); \drawit{-.85cm} \end{scope}
    \begin{scope} \clip (3.7,-.3) rectangle (4.3,.3); \drawit{-.47cm} \end{scope}
    \begin{scope} \clip (-.7,-.3) rectangle (-1.3,.3); \drawit{1.5cm} \end{scope}
    \begin{scope} \clip (-1.7,-.3) rectangle (-2.3,.3); \drawit{1.2cm} \end{scope}
    \begin{scope} \clip (-2.7,-.3) rectangle (-3.3,.3); \drawit{-.55cm}; \end{scope}
    \begin{scope} \clip (-3.7,-.3) rectangle (-4.3,.3); \drawit{-1cm} \end{scope}
    \node[blue] at (3,-1.5) {$f(x+\dx)-f(x)$};
  \end{tikzpicture}
\end{center}
Note that the pieces of the graph of $f(x+\dx)-f(x)$ all look quite close to straight lines.
This is what happens whenever we ``zoom in'' sufficiently on a smooth function, leading to the definition of differentiation (see \cref{sec:differentials}).
